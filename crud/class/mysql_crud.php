...
class Database
{
    ...
    private $db_pass = "admin";  // Change as required
    private $db_name = "cms"; // Change as required

    /* Live DB */

    /* private $db_host = "localhost";  // Change as required
      private $db_user = "zena_master";  // Change as required
      private $db_pass = "ZTF1y_zCxAom";  // Change as required
      private $db_name = "zena_mastersessay"; // Change as required */
    /*
    ...
    public function getColoumn($table)
    {
	$fieldnames = array();
	if ($this->tableExists($table))
	{
	    ...
	    if (!$result)
	    {
		array_push($this->result, 'Could not run query: ' . mysql_error());
		return false; // The table does not exist
	    }
