...
<!--                    <select style="display: none;" id="level" name="level" size="1">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div style="width: 300px; float: left;">
                        <label style="width: 50px; float: left;"><a href="">USD</a></label>
                        <label style="width: 50px; float: left;"><a href="">EUR</a></label>
                        <label style="width: 50px; float: left;"><a href="">GBP</a></label>
                        <label style="width: 50px; float: left;"><a href="">AUD</a></label>
                    </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="input-xlarge" name="cost_per_page" id="cost_per_page" value="" placeholder="cost per page" readonly>
                </div>
            </div>
             <div class="control-group">
                <label class="control-label" for="page_summery">1-page summary of your paper:<span></span></label>
                <div class="controls">
                    <input type="checkbox" class="input-xlarge" name="page_summery" id="page_summery" value="" placeholder="Page summery" >
                    <input type="text" class="input-xlarge" name="page_summery" id="page_summery" value="" placeholder="" style=" width:251px;" readonly>
             ...
             <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="input-xlarge" name="total" id="total" value="" placeholder="" readonly>
                    <a href="" title="The whole paper briefly on 1 page - for you to get the main points of the research and ready for the tentative questions from your tutor. Advised to those who will also be asked live on the topic researched"><img src="./theme/img/help.png" alt="hlep" /></a>
                </div>
            </div>
            ...
            <div class="control-group">
             ...
             <div class="control-group">
                <label class="control-label" for="preferred_lang">Preferred language style: <span></span></label>
                <div class="controls">
                    <input type="radio" checked="checked" name="us_writer" id="us_writer" style="float: left;" >
                    <label class="control-label" for="us_writer" style=" padding:0px 0 0 2px; width: auto; ">I want a US writer</label>
                    <input type="radio" name="uk_writer" id="us_writer" style="float: left;" >
                    <label class="control-label" for="uk_writer" style=" padding:0px 0 0 2px; width: auto; ">I want a UK writer (+10% to the order total)</label>
             ...
             <div class="control-group">
                ...
                <div class="controls">
                    <textarea id="order_description" name="order_description" rows="7" cols=""></textarea><br/>
              ...
              <div class="control-group">
                <label class="control-label" for="night_calls">Night calls allowed: <span></span></label>
                <div class="controls">
                    <input type="checkbox" checked="checked"  size="1" value="" name="night_calls" id="night_calls">
                    <a href="" title="The whole paper briefly on 1 page - for you to get the main points of the research and ready for the tentative questions from your tutor. Advised to those who will also be asked live on the topic researched"><img src="./theme/img/help.png" alt="hlep" /></a>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" value="" name="preferred_writers_id" id="preferred_writers_id">
                    <a href=""><img src="./theme/img/add.jpg" alt="hlep" /></a><br/>
...
<!--	    <div class="form-actions">
        ...
        <fieldset>
            <legend>Discount program</legend>
            <div class="control-group">
                <label class="control-label" for="discount_code">Discount Code:<span>*</span></label>
                <div class="controls">
                    <input type="text" class="input-xlarge" name="discount_code" id="discount_code" value="" placeholder=""><br/>
                    <span>Please, be aware that membership discounts are not applied to orders under $30.00</span><br/>
                    <input type="radio" name="" id="" > <lebel>I accept terms and conditions </lebel>
                    <input type="radio"  name="" id="" > <lebel>I accept terms and conditions </lebel>
