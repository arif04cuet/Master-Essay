...
<div class="block sidebar">
    ...
    <div class="block-content">
        <div>
            <ul class="nav">
                <li><a href="#">FREE Outline <span class="pull-right">$5</span></a> </li>
                <li><a href="#">FREE Unlimited Amendments*  <span class="pull-right">$30</span></a></li>
                <li><a href="#">FREE Title Page  <span class="pull-right">$5</span></a></li>
                <li><a href="#">FREE Bibliography  <span class="pull-right">$15</span></a></li>
                <li><a href="#">FREE Formatting  <span class="pull-right">$10</span></a></li>
